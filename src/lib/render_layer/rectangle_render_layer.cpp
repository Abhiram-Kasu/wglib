...
namespace wglib::render_layers {
  ...
  auto RectangleRenderLayer::initRes(const wgpu::Device &device,
    ...
    if (!m_render_pipeline)
      RectangleRenderLayer::initRenderPipeline(device, format, bindGroupLayout);
  }
  ...
  auto RectangleRenderLayer::initRenderPipeline(const wgpu::Device &device,
  ...
  auto RectangleRenderLayer::Render(wgpu::RenderPassEncoder &renderPass) -> void {
    ...
    renderPass.SetPipeline(m_render_pipeline.value());
